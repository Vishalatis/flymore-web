...
! function(e, t) {
        ...
        fn: function(e) {
            ...
            if (!t.modifiersData[s]._skip) {
                for (var n = i.mainAxis, r = void 0 === n || n, a = i.altAxis, o = void 0 === a || a, l = i.fallbackPlacements, c = i.padding, d = i.boundary, u = i.rootBoundary, h = i.altBoundary, p = i.flipVariations, f = void 0 === p || p, m = i.allowedAutoPlacements, g = t.options.placement, v = fe(g), _ = l || (v !== g && f ? function(e) {
                    ...
                    var I = De(L),
                        D = [];
                    if (r && D.push(A[P] <= 0), o && D.push(A[L] <= 0, A[I] <= 0), D.every((function(e) {
                            return e
                        }))) {
                        E = C, T = !1;
                        break
                ...
                if (x) {
                    if (r) {
                        var P = "y" === b ? te : ne,
                            ...
                            B = j[M],
                            H = Ee(0, T[k], N[k]),
                            W = y ? T[k] / 2 - I - H - F - S : D - H - F - S,
                            q = y ? -T[k] / 2 + I + H + B + S : z + H + B + S,
                            ...
                            G = x[b] + W - V - X,
                            $ = x[b] + q - V,
                            U = Ee(p ? Math.min(A, G) : A, O, p ? Math.max(L, $) : L);
                        x[b] = U, C[b] = U - O
                    }
                    if (o) {
                        var Q = "x" === b ? te : ne,
    ...
    var nt = st(),
        rt = st({
            defaultModifiers: [Le, Ze, Oe, pe]
        }),
        at = st({
            defaultModifiers: [Le, Ze, Oe, pe, Ke, Ge, Je, Pe, Qe]
        }),
        ot = Object.freeze({
            __proto__: null,
            popperGenerator: st,
...
function(e) {
    ...
    e.magnificPopup.registerModule(A, {
        ...
        proto: {
            initAjax: function() {
                t.types.push(A), O = t.st.ajax.cursor, b(o + "." + A, I), b("BeforeChange." + A, I)
            },
            getAjax: function(i) {
                ...
                var s = e.extend({
                    ...
                    success: function(s, n, r) {
                        ...
                        x("ParseAjax", a), t.appendContent(e(a.data), A), i.finished = !0, L(), t._setFocus(), setTimeout((function() {
                            t.wrap.addClass(f)
        ...
        const X = {
                ...
                events: {
                    attachEvents: function() {
                        ...
                        e.onTouchStart = L.bind(e), e.onTouchMove = I.bind(e), e.onTouchEnd = D.bind(e), i.cssMode && (e.onScroll = N.bind(e)), e.onClick = R.bind(e), e.onLoad = j.bind(e), F || (t.addEventListener("touchstart", B), F = !0), H(e, "on")
                    },
        ...
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], (function(e, t, i) {
                ...
                var he = function(e, t, i, s) {
                        ...
                        return d ? n = t ? function(e) {
                            ...
                            if ("number" == typeof e) e += u;
                                ...
                                for (f = e.replace(L, "|").split("|"), p = 0; f.length > p; p++) f[p] = n(f[p]);
                                return f.join(",")
                            }
                            ...
                            if ("number" == typeof e) e += u;
                                ...
                                for (r = e.replace(L, "|").split("|"), h = 0; r.length > h; h++) r[h] = n(r[h]);
                                return r.join(",")
                            }
                    ...
                    ve = a.parseComplex = function(e, t, i, s, n, r, a, o, l, c) {
                        ...
                        var u, h, p, f, m, _, y, b, w, x, T, E, S, C = i.split(", ").join(",").split(" "),
                            ...
                            M = C.length,
                            k = !1 !== d;
                        for ((-1 !== s.indexOf(",") || -1 !== i.indexOf(",")) && (C = C.join(" ").replace(L, ", ").split(" "), P = P.join(" ").replace(L, ", ").split(" "), M = C.length), M !== P.length && (M = (C = (r || "").split(" ")).length), a.plugin = l, a.setRatio = c, ue.lastIndex = 0, u = 0; M > u; u++)
                ...
                var xe, Te = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                    ...
                    Ne = B.getTransform = function(e, i, s, r) {
                        ...
                        if (p.svg = !(!e.getBBox || !De(e)), p.svg && (Ie(e, U(e, Ce, n, !1, "50% 50%") + "", p, e.getAttribute("data-svg-origin")), xe = a.useSVGTransformAttr || Le), (o = Re(e)) !== ze) {
                            if (16 === o.length) {
                                var y, b, w, x, T, E = o[0],
                                    S = o[1],
                                    C = o[2],
                                    ...
                                    F = o[11],
                                    B = Math.atan2(O, z);
                                p.zOrigin && (R = L * (j = -p.zOrigin) - o[12], N = I * j - o[13], j = z * j + p.zOrigin - o[14]), p.rotationX = B * D, B && (y = M * (x = Math.cos(-B)) + L * (T = Math.sin(-B)), b = k * x + I * T, w = O * x + z * T, L = M * -T + L * x, I = k * -T + I * x, z = O * -T + z * x, F = A * -T + F * x, M = y, k = b, O = w), B = Math.atan2(L, z), p.rotationY = B * D, B && (b = S * (x = Math.cos(-B)) - I * (T = Math.sin(-B)), w = C * x - z * T, I = S * T + I * x, z = C * T + z * x, F = P * T + F * x, E = y = E * x - L * T, S = b, C = w), B = Math.atan2(S, E), p.rotation = B * D, B && (E = E * (x = Math.cos(-B)) + M * (T = Math.sin(-B)), b = S * x + k * T, k = S * -T + k * x, O = C * -T + O * x, S = b), p.rotationX && Math.abs(p.rotationX) + Math.abs(p.rotation) > 359.9 && (p.rotationX = p.rotation = 0, p.rotationY += 180), p.scaleX = (0 | Math.sqrt(E * E + S * S) * g + .5) / g, p.scaleY = (0 | Math.sqrt(k * k + I * I) * g + .5) / g, p.scaleZ = (0 | Math.sqrt(O * O + z * z) * g + .5) / g, p.skewX = 0, p.perspective = F ? 1 / (0 > F ? -F : F) : 0, p.x = R, p.y = N, p.z = j, p.svg && (p.x -= p.xOrigin - (p.xOrigin * E - p.yOrigin * M), p.y -= p.yOrigin - (p.yOrigin * S - p.xOrigin * k))
                    ...
                    Fe = B.set3DTransformRatio = B.setTransformRatio = function(e) {
                        var t, i, s, n, r, a, o, l, c, d, u, h, f, m, g, v, _, y, b, w, x, T, E, S = this.data,
                            ...
                            j = S.perspective,
                            F = S.force3D;
                        if (!((1 !== e && 0 !== e || "auto" !== F || this.tween._totalTime !== this.tween._totalDuration && this.tween._totalTime) && F || R || j || k || M) || xe && N || !Pe) P || S.skewX || N ? (P *= I, T = S.skewX * I, E = 1e5, t = Math.cos(P) * O, n = Math.sin(P) * O, i = Math.sin(P - T) * -A, r = Math.cos(P - T) * A, T && "simple" === S.skewType && (_ = Math.tan(T), i *= _ = Math.sqrt(1 + _ * _), r *= _, S.skewY && (t *= _, n *= _)), N && (D += S.xOrigin - (S.xOrigin * t + S.yOrigin * i) + S.xOffset, z += S.yOrigin - (S.xOrigin * n + S.yOrigin * r) + S.yOffset, xe && (S.xPercent || S.yPercent) && (m = this.t.getBBox(), D += .01 * S.xPercent * m.width, z += .01 * S.yPercent * m.height), (m = 1e-6) > D && D > -m && (D = 0), m > z && z > -m && (z = 0)), b = (0 | t * E) / E + "," + (0 | n * E) / E + "," + (0 | i * E) / E + "," + (0 | r * E) / E + "," + D + "," + z + ")", N && xe ? this.t.setAttribute("transform", "matrix(" + b) : C[Ee] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) matrix(" : "matrix(") + b) : C[Ee] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) matrix(" : "matrix(") + O + ",0,0," + A + "," + D + "," + z + ")";
                        else {
                            if (p && ((m = 1e-4) > O && O > -m && (O = L = 2e-5), m > A && A > -m && (A = L = 2e-5), !j || S.z || S.rotationX || S.rotationY || (j = 0)), P || S.skewX) P *= I, g = t = Math.cos(P), v = n = Math.sin(P), S.skewX && (P -= S.skewX * I, g = Math.cos(P), v = Math.sin(P), "simple" === S.skewType && (_ = Math.tan(S.skewX * I), g *= _ = Math.sqrt(1 + _ * _), v *= _, S.skewY && (t *= _, n *= _))), i = -v, r = g;
                            else {
                                if (!(k || M || 1 !== L || j || N)) return void(C[Ee] = (S.xPercent || S.yPercent ? "translate(" + S.xPercent + "%," + S.yPercent + "%) translate3d(" : "translate3d(") + D + "px," + z + "px," + R + "px)" + (1 !== O || 1 !== A ? " scale(" + O + "," + A + ")" : ""));
                                t = r = 1, i = n = 0
                            }
        ...
        if (!i.TweenLite) {
            ...
            k(), r.play = function(e, t) {
                ...
                if (this._timeline) {
                    ...
                    this._gc && this._enabled(!0, !1), (this._totalTime !== e || 0 === this._duration) && (I.length && $(), this.render(e, t, !1), I.length && $())
                }
                return this
            ...
            V._startTime = a.time, X._startTime = a.frame, V._active = X._active = !0, setTimeout($, 1), M._updateRoot = A.render = function() {
                var e, t, i;
                if (I.length && $(), V.render((a.time - V._startTime) * V._timeScale, !1, !1), X.render((a.frame - X._startTime) * X._timeScale, !1, !1), I.length && $(), a.frame >= G) {
            ...
            r._init = function() {
                ...
                if (null == e) return [];
                var i, s, n, r;
                if (e = "string" != typeof e ? e : A.selector(e) || e, (p(e) || L(e)) && "number" != typeof e[0]) {
