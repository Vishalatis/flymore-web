! function(e) {
    ...
    e(l).on("submit", (function(e) {
        ...
        e(this).each((function() {
            ...
            n = Math.floor(l.height() / 2), s = l.attr(t), o = l.attr(a), i = p(e(o).css("padding-top")), r = p(e(o).css("padding-bottom")), "top-half" === s ? (e(o).css("padding-bottom", r + n + "px"), l.css("margin-top", "-" + n + "px")) : "bottom-half" === s && (e(o).css("padding-top", i + n + "px"), l.css("margin-bottom", "-" + n + "px"))
        }))
    };
    ...
    })), window.addEventListener("mousemove", g), window.addEventListener("touchstart", g), window.addEventListener("touchmove", g), window.addEventListener("contextmenu", (function(e) {
        e.preventDefault()
